      ...
      <el-container>
        ...
        <el-header style="height: 100px;background-color: #ffffff !important;">
          ...
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item  :to="{path:'/homework'}" style="font-size: larger;font-weight: bold">任务</el-breadcrumb-item>
          </el-breadcrumb>
...
export default {
  ...
  methods: {
    ...
    filterData() {
      this.filteredTableData = this.tableData.filter(item => item.ahCategory === '平时作业' || item.ahCategory === '考试');
    },
