      ...
      <el-container>
        ...
        <el-header style="height: 100px;background-color: #ffffff !important;">
          ...
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item  :to="{path:'/homework'}" style="font-size: larger;font-weight: bold">教材</el-breadcrumb-item>
          </el-breadcrumb>
        ...
        <el-container style="padding: 20px">
          <el-main style="height: 100vh;background-color:white;padding-top: 50px">
            <el-table :data="filteredTableData" style="width: 100%">
              ...
              <el-table-column prop="startTime" label="教材上传时间" width="180" />
...
export default {
  ...
  methods: {
    ...
    filterData() {
      this.filteredTableData = this.tableData.filter(item => item.ahCategory === '教材');
    },
