      ...
      <el-container>
        ...
        <el-header style="height: 100px;background-color: #ffffff !important;">
          ...
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="{path:'/homework'}" style="font-size: larger;font-weight: bold">课程视频</el-breadcrumb-item>
            <el-breadcrumb-item  :to="{path:'/homework'}" style="font-size: larger;font-weight: bold">课程回放</el-breadcrumb-item>
          </el-breadcrumb>
        ...
        <el-container style="padding: 20px">
          <el-main style="height: 100vh;background-color:white;padding-top: 50px">
            <el-table :data="tableData" style="width: 100%">
              ...
              <el-table-column prop="attachment" label="附件号" width="100" />

              <el-table-column label="操作" align="center">
                <template v-slot="scope">

                  <!-- 根据Isteacher的值决定是否显示发批改作业的按钮 -->
                  <el-button v-if="Isteacher === '1'" @click="handleCreate">发布作业</el-button>
                  <!-- 当Isteacher等于0时，显示提交作业的按钮 -->
                  <el-button v-if="Isteacher === '0'" @click="handleSubmitHomework">提交作业</el-button>
