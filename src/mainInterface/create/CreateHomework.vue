      ...
      <el-container>
        ...
        <el-header style="height: 100px;background-color: #ffffff !important;">
          ...
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="{path:'/ch'}" style="font-size: larger;font-weight: bold">创建任务</el-breadcrumb-item>
        ...
        <el-container style="padding: 20px">
          <el-main style="height: 100vh;background-color:white;padding-top: 50px">
            <el-form ref="assignHomeworkForm" :model="assignHomework" label-width="120px">
              ...
              <el-form-item label="作业截至时间">
                <el-date-picker v-model="assignHomework.endTime" type="date" placeholder="选择日期"></el-date-picker>
              </el-form-item>
              <el-form-item label="类别">
                <el-select v-model="assignHomework.ahCategory" placeholder="请选择">
                  <el-option label="平时作业" value="平时作业">平时作业</el-option>
                  <el-option label="平时作业" value="考试">考试</el-option>
                  <!-- 根据实际情况添加更多类别 -->
                </el-select>
              </el-form-item>
