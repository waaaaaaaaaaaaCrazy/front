<template>
    <div class="function">
        ...
        <el-menu :default-active="defaultView" class="side-menu" background-color="#545c64" text-color="#fff"
            ...
            <el-menu-item index="notice_annouce" v-if="isTeacher === 1" @click="currentView = 'notice_annouce'">通知发布</el-menu-item>
            <el-menu-item index="notice_drafts" v-if="isTeacher === 1" @click="currentView = 'notice_drafts'">草稿箱</el-menu-item>
            <router-link to="/home">
